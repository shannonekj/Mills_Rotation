...
# run with
# sbatch -p med -A millsgrp -t 5-36:00:00 --mem MaxMemPerNode bmtagger_metasim_QC.sh
#tell slurm output what you are doing
echo "Decontamination of QC'd MetaSim files with BMTagger"
...
#Navigate to /group/kmkalangrp/SEKJ_work/bmtagger
cd ../bmtagger
